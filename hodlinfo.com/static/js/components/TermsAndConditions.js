...
const TermsAndConditions = () => {
    return ( <
            ...
            /h2> <
            p > Last updated: 2021 - 02 - 02 < /p> <
            p >
            1. < b > Introduction < /b> <
            /p> <
            p >
            Welcome to < b > QuadB Technologies < /b> (“Company”, “we”, “our”, “us”)! <
            /p> <
            p >
            These Terms of Service(“Terms”, “Terms of Service”) govern your use of our website located at < b > https: //hodlinfo.com</b> (together or
            individually“ Service”) operated by < b > QuadB Technologies < /b>. <
        /p> <
        p >
    ...
    let us know by emailing at {
        ...
        b > rupin @quadbtech.com < /b> so we can try to find a solution. These
    ...
    rupin @quadbtech.com. <
        ...
        /p> <
        p >
        Any contests, sweepstakes or other promotions(collectively, “Promotions”) made available through Service may be governed by rules
    ...
    Privacy Policy.If the rules
    for a Promotion conflict with these Terms
        ...
        /p> <
        p >
        Content found on or through this Service are the property of QuadB
    Technologies or used with permission.You may not distribute, modify,
        transmit, reuse, download, repost, copy, or use said Content, whether in whole or in part,
    ...
    promotional material, including any“ junk mail”, “chain letter, ”“spam, ”or any other similar solicitation. <
        /p> <
        p >
    ...
    means to access Service
    for any purpose, including monitoring or
    copying any of the material on Service. <
        /p> <
        p >
        0.3.Use any manual process to monitor or copy any of the material on
    Service or
    for any other unauthorized purpose without our prior
    written consent. <
        /p> <
        p >
    ...
    for access and use by individuals at least
    ...
    both the access and usage of Service. <
        ...
        /p> <
        p >
        Service and its original content(excluding Content provided by users), features and functionality are and will remain the exclusive
    property of QuadB Technologies and its licensors.Service is protected
    ...
    without the prior written consent of QuadB Technologies. <
        /p> <
        p >
    ...
    to rupin @quadbtech.com, with the subject line: “Copyright
    ...
    for damages(including costs and attorneys’ fees) for misrepresentation or bad - faith claims on the
    infringement of any Content found on and / or through Service on your
    copyright. <
        /p> <
        p >
        10. < b > DMCA Notice and Procedure
    for Copyright Infringement Claims < /b> <
        /p> <
        p >
    ...
    owner or authorized to act on the copyright owner’ s behalf. <
        ...
        /p> <
        p >
        You may provide us either directly at rupin @quadbtech.com or via third
    ...
    free - of -charge, sub - licensable, unlimited and perpetual right to use(including copy, modify, create derivative works, publish, distribute and commercialize) Feedback in any manner and
    for any purpose. <
        /p> <
        p >
    ...
    that are not owned or controlled by QuadB Technologies. <
        /p> <
        p >
        QuadB Technologies has no control over, and assumes no responsibility
    ...
    for generating high - quality legal documents.PolicyMaker’ s {
        ...
        /a>{" "}
    is an easy - to - use free tool
    for creating an excellent standard Terms
        of Service template
    ...
    OR LIMITED UNDER APPLICABLE LAW. <
        ...
        SPECIAL, INCIDENTAL, OR CONSEQUENTIAL DAMAGE, HOWEVER IT ARISES(INCLUDING ATTORNEYS’ FEES AND ALL RELATED COSTS AND EXPENSES OF LITIGATION AND ARBITRATION, OR AT TRIAL OR ON APPEAL, IF ANY, WHETHER OR NOT LITIGATION OR ARBITRATION IS INSTITUTED), WHETHER IN AN ACTION
    ...
    notice.We will not be liable
    if for any reason all or any part of
        Service is unavailable at any time or
    for any period.From time to
    ...
    for technical support by
    email: < b > rupin @quadbtech.com < /b>. <
        /p> <
        p style = {
            {
                marginTop: "5em",
        ...
        These < a > Terms of Service < /a> were created for{" "} <
        b > https: //hodlinfo.com</b>
        <
        /p> <
        /div> <
        />
